    ...
    var body: some View {
        NavigationStack {
            List {
                ...
                Section("Privacy") {
                    Label("No Internet Access", systemImage: "lock.shield")
                    Label("No Cloud Sync", systemImage: "icloud.slash")
                    Label("No Analytics or Tracking", systemImage: "eye.slash")
                    Label("Data Stored On-Device Only", systemImage: "iphone")

                    Text("LibreRing has zero network permissions. Your health data never leaves your device except through Apple Health, which you control.")
                        .font(.caption)
                        .foregroundStyle(.secondary)
                }
                ...
                Section("About") {
                    ...
                    Link(destination: URL(string: "https://github.com/your-repo/librering")!) {
